...
data Block
  = Paragraph (L.List Inline)
  | Header Int (L.List Inline)
  | Blockquote (L.List Block)
  | Lst ListType (L.List (L.List Block))
...
instance arbitraryBlock :: SC.Arbitrary Block where
  arbitrary = do
